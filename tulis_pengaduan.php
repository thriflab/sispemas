       ...
       <div class="form-group cols-sm6">
        ...
        <div class="form-group cols-sm6">
         ...
         <div class="form-group cols-sm6">
          ...
          <input type="file" name="foto"  class="form-control" accept=".jpg , .jpeg , .png , .gif"><font color="dark"> * tipe yang bisa di upload adalah : .jpeg , .jpg , .png , .gif</font>
         </div>

         <div class="form-group col-sm-6">
           <input type="submit" value="simpan" class="btn btn-primary" name="">
           <input type="reset" value="Kosongkan" class="btn btn-warning" name="">
         </div>
    </form>
    </div>
</div>
